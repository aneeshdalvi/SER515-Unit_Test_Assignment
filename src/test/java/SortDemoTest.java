...
public class SortDemoTest{
	...
	*/
	...
	public void SameNumber() {
		...
		assertTrue(data2.myArray[0].key == data2.myArray[0].key );
		assertTrue(data2.myArray[1].key == data2.myArray[1].key );
		assertTrue(data2.myArray[2].key == data2.myArray[2].key );
	}
